							...
							<form method="post">
								...
								<table style="width: 100%">
									<tr>
										...
										<td><input autocomplete="off" type="text" name="name" value="$4" /></td>
									</tr>
									<tr>
										<td>Real name:</td>
										<td><input autocomplete="off" type="text" name="realname" value="$5" /></td>
									</tr>
									<tr>
										<td>Email:</td>
										<td><input autocomplete="off" type="text" name="email" value="$6" /></td>
									</tr>
									<tr>
										<td>Password:</td>
